...
contentLoaded(window, function () {
  ...
  var iomock_project_base;

  $.each(document.cookie.split(/; */), function()  {
    var splitCookie = this.split('=');
    if(splitCookie[0] == 'iomock_project_base') {
      iomock_project_base = splitCookie[1];
    }
  });

  var IOMock = function() {
    this.data = null;
    this.project_base = iomock_project_base;
    this.project_suffix = '.json';
    this.asset_base = iomock_project_base;
    this.asset_suffix = '';
