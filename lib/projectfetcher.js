...
exports.fetchProject = function(projectId, projectsDirectory){
  ...
  return requestPromise({url: project_url})
          .then(function(res){
...
var handleProjectJsonResponse = function(arguments) {
  ...
  promises.push(
    writeFilePromise(projects_directory + projectId + '.json', body)
